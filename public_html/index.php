<?php
    if(isset($_GET['testjob'])&&$_GET['testjob']=='true'){
        header('Location: addlead.php', 302);
    } elseif(isset($_GET['status'])&&$_GET['status']!=null){
        ?>
        <html>
			...
			<div class="row">
				<div class="col">
					...
					<div class="description-text animate__animated animate__fadeIn animate__delay-1s">
						...
						<section class="footer"><strong>Domain:</strong> spacemarketing.pererva.pro</section>
					</div>
				</div>
			</div>
		</div>
